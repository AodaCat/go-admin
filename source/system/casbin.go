...
func (c *casbin) CheckDataExist() bool {
	return !errors.Is(global.GA_DB.Where(adapter.CasbinRule{Ptype: "p", V0: "9528", V1: "GET", V2: "/user/getUserInfo"}).First(&adapter.CasbinRule{}).Error, gorm.ErrRecordNotFound)
}
