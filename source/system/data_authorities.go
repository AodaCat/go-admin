...
func (a *dataAuthorities) CheckDataExist() bool {
	return !errors.Is(global.GA_DB.Where("sys_authority_authority_id = ? AND data_authority_id_authority_id = ?", "9528", "9528").First(&AuthoritiesResources{}).Error, gorm.ErrRecordNotFound)
}
